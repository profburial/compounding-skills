---
name: skill-auditor
description: Background knowledge for auditing generated .claude/ skills — how to evaluate quality, run benchmarks, and iteratively improve them using test cases and quantitative metrics.
...
1. **Audit generated skills** — evaluate whether they actually improve Claude's output quality
