...
Full templates for each workflow skill generated by `compounding-skills:setup`. All 5 skills are always created. Each skill gets its own directory under `.claude/skills/{command_prefix}-{skill_name}/SKILL.md`.
...
**Path:** `.claude/skills/{command_prefix}-brainstorm/SKILL.md`
...
**Path:** `.claude/skills/{command_prefix}-plan/SKILL.md`
...
**Path:** `.claude/skills/{command_prefix}-work/SKILL.md`
...
**Path:** `.claude/skills/{command_prefix}-review/SKILL.md`
...
**Path:** `.claude/skills/{command_prefix}-compound/SKILL.md`
...
When generating skills, substitute all `{variable}` placeholders:
